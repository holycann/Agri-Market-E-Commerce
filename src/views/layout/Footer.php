        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p class="text-green-100">Your trusted marketplace for agricultural products, connecting farmers with buyers directly.</p>
                </div>
                ...
                <div>
                    ...
                    <form id="newsletter-form" class="space-y-4">
                        <input type="email" placeholder="Your email address" class="w-full px-4 py-2 rounded bg-green-500 text-white placeholder-green-200 focus:outline-none focus:ring-2 focus:ring-white">
                        <button type="submit" class="w-full bg-white text-green-600 px-4 py-2 rounded hover:bg-green-100 transition duration-200">Subscribe</button>
                    </form>
                </div>
            </div>
