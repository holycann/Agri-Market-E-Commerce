    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                ...
                <p class="text-xl text-gray-600 mb-6">Support local farmers and get the freshest produce at competitive
                    prices.</p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?= BASE_ENDPOINT ?>/products"
                        class="inline-block bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 transition duration-200">
                        Shop Now
                    </a>
                    <a href="<?= BASE_ENDPOINT ?>/market-insights"
                        class="inline-block bg-white text-green-600 border border-green-600 px-6 py-3 rounded-lg font-medium hover:bg-green-50 transition duration-200">
                        Market Insights
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <a href="/products/livestock" class="group">
                <div class="rounded-lg overflow-hidden bg-white shadow-md hover:shadow-lg transition duration-200">
                    ...
                    <div class="p-4">
                        <h3
                            class="text-lg font-semibold text-gray-900 group-hover:text-green-600 transition duration-200">
                            Livestock</h3>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-600">"AgriMarket has transformed how I source my restaurant's produce. The quality
                    and freshness are unmatched, and I love supporting local farmers directly."</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-600">"As a small-scale farmer, AgriMarket has opened up new markets for me. The
                    platform is easy to use, and I've been able to grow my customer base significantly."</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-600">"The market insights feature has been invaluable for planning my farm's
                    production schedule. Being able to see price trends helps me make informed decisions about what to
                    grow."</p>
            </div>
        </div>
    </div>
...
<section class="py-12 bg-green-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Stay informed about agricultural market trends and make
...
<section class="py-16 bg-gradient-to-r from-green-600 to-green-700 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl mb-8 max-w-3xl mx-auto">Join our platform to reach more customers, get fair prices for your
            products, and grow your agricultural business.</p>
        <a href="/vendor/register"
            class="inline-block bg-white text-green-700 px-8 py-4 rounded-lg font-bold text-lg hover:bg-green-50 transition duration-200">
            Become a Vendor
        </a>
    </div>
</section>
